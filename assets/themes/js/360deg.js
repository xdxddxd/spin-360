function externoSpin() {
  (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
    1: [function (require, module, exports) {
      ...
      var el = document.querySelector('.deg-externo');
      ...
      /**
       * Remova o callback de chamada fornecido para `evento` ou todos
      ...
      Emitter.prototype.off =
        ...
        Emitter.prototype.removeEventListener = function (event, fn) {
          ...
          // remove um manipulador especifico
          var cb;
      ...
      /**
       * Emite `evento` com os argumentos fornecidos.
       *
       * @param {String} event
       * @param {Mixed} ...
       * @return {Emitter}
      ...
      /**
       * Retorna array do callbacks para `evento`.
       *
       * @param {String} event
       * @return {Array}
       * @api public
      ...
      /**
       * Verifique se este emissor tem `evento` manipulador.
       *
       * @param {String} event
       * @return {Boolean}
       * @api public
...
function internoSpin() {
  (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
    1: [function (require, module, exports) {
      ...
      var el = document.querySelector('.deg-interno');
      var btnScroll = document.querySelector('.btn-scroll');
      var btnCycle = document.querySelector('.btn-cycle');
      var btnReverse = document.querySelector('.btn-reverse');
      var btnPrev = document.querySelector('.btn-prev');
